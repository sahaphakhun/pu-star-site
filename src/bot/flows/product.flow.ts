...
export async function sendWelcome(psid: string) {
  ...
  sendTypingAndMessages(psid, {
    text: 'สวัสดีค่ะ กรุณาเลือกเมนูที่ต้องการ 🙏🏻\n • สอบถามข้อมูลเพิ่มเติม เลือกเมนูด้านล่างได้เลยค่ะ\n • ต้องการสั่งซื้อ กรุณาทำรายการผ่านเว็บไซต์: www.winrichdynamic.com',
    quick_replies: [
