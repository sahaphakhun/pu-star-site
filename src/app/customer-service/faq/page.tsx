...
const faqData = [
  {
    ...
    faqs: [
      ...
      {
        question: "ผลิตภัณฑ์ Next Star Innovation มีการรับประกันหรือไม่?",
        answer: "ผลิตภัณฑ์ทุกชิ้นของ Next Star Innovation ได้รับการรับประกันคุณภาพตามที่ระบุไว้ในเอกสารผลิตภัณฑ์ หากพบปัญหาใดๆ กรุณาติดต่อฝ่ายบริการลูกค้าของเราทันทีที่ support@pustar-thailand.com"
      },
      {
        question: "ซีลแลนท์และกาวของ Next Star Innovation เก็บรักษาได้นานเท่าไร?",
        answer: "ผลิตภัณฑ์ซีลแลนท์และกาวของ Next Star Innovation มีอายุการใช้งานประมาณ 12-18 เดือนหลังจากวันที่ผลิต เมื่อเก็บในที่แห้งและเย็น อุณหภูมิระหว่าง 5-25°C วันหมดอายุจะระบุไว้บนบรรจุภัณฑ์"
      },
      {
        question: "ผลิตภัณฑ์ Next Star Innovation มีใบรับรองคุณภาพหรือไม่?",
        answer: "ผลิตภัณฑ์ของ Next Star Innovation ได้รับการรับรองมาตรฐานสากลหลายรายการ รวมถึง ISO 9001, ISO 14001 และได้รับการทดสอบตามมาตรฐาน ASTM และ JIS สำหรับใบรับรองเฉพาะผลิตภัณฑ์ สามารถดาวน์โหลดได้จากหน้าผลิตภัณฑ์หรือติดต่อฝ่ายขาย"
      },
      {
    ...
    faqs: [
      {
        ...
        answer: "หากคุณสนใจเป็นตัวแทนจำหน่ายผลิตภัณฑ์ Next Star Innovation ในประเทศไทย โปรดส่งอีเมลมาที่ partnership@pustar-thailand.com พร้อมแนบประวัติบริษัท และแผนธุรกิจ ทีมงานของเราจะติดต่อกลับภายใน 3 วันทำการ"
      },
      {
  ...
  },
  {
    ...
    faqs: [
      {
        question: "Next Star Innovation เป็นบริษัทของประเทศอะไร?",
        answer: "Next Star Innovation เป็นแบรนด์จากประเทศเยอรมนี ก่อตั้งในปี ค.ศ. 1995 มีฐานการผลิตในทวีปยุโรปและเอเชีย โดยมีสำนักงานใหญ่สำหรับภูมิภาคเอเชียตะวันออกเฉียงใต้ตั้งอยู่ที่ประเทศไทย"
      },
      {
        question: "ผลิตภัณฑ์ของ Next Star Innovation เป็นมิตรกับสิ่งแวดล้อมหรือไม่?",
...
export default function FAQPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto py-12 px-4">
      ...
      <p className="text-gray-600 mb-8">ค้นหาคำตอบสำหรับคำถามที่พบบ่อยเกี่ยวกับผลิตภัณฑ์และบริการของ Next Star Innovation</p>
