          ...
          {products.map((product) => (
            ...
            >
              ...
              <Link
                ...
                className="mt-auto bg-primary text-white rounded px-4 py-2 text-center hover:bg-primary/80 transition"
              >
                ดูรายละเอียด
              </Link>
            </div>
