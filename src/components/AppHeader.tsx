...
export default function AppHeader({ showSearch = true, onSearchToggle }: AppHeaderProps) {
  ...
  const menuItems = [
    ...
    { href: isLoggedIn ? '/profile' : '/login?returnUrl=/profile', label: 'ข้อมูลส่วนตัว', icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>, show: true },
        ...
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center space-x-3">
            ...
            >
              ...
              {totalUnread > 0 && (
                <span className="absolute -top-0.5 -right-0.5 bg-red-600 text-white text-[10px] leading-[14px] min-w-[14px] h-[14px] px-1 rounded-full flex items-center justify-center">
