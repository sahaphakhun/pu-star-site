  ...
  return (
    <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
      ...
      <div className="text-xs text-gray-500">
            ...
            ใช้ปุ่ม "เลื่อนแผนที่เพื่อปักหมุด" เพื่อเลือกตำแหน่งแบบ interactive (แนะนำ!)<br/>
                    <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
            </svg>
            หรือกรอกพิกัดเอง (หาได้จาก Google Maps <svg className="w-3 h-3 inline mx-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg> กดค้างที่ตำแหน่ง <svg className="w-3 h-3 inline mx-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg> คัดลอกพิกัด)<br/>
                    <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
